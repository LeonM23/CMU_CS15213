...
0000000000400da0 <main>:
  ...
  400e3a:	e8 a1 00 00 00       	callq  400ee0 <phase_1> # 比较输入的字符是否为 "Border relations with Canada have never been better."
...
000000000040131b <string_length>:
  ...
  40131e:	74 12                	je     401332 <string_length+0x17> # 第一个字符为0，直接返回0
  401320:	48 89 fa             	mov    %rdi,%rdx # 将rdi移动到rdx, rdx = rdi
  401323:	48 83 c2 01          	add    $0x1,%rdx # rdx = rdx + 1 = rdi + 1
...
0000000000401338 <strings_not_equal>:
  ...
  40133a:	55                   	push   %rbp
  40133b:	53                   	push   %rbx # 保存rbp和rbx
  40133c:	48 89 fb             	mov    %rdi,%rbx
  40133f:	48 89 f5             	mov    %rsi,%rbp # 保存rdi和rsi
  401342:	e8 d4 ff ff ff       	callq  40131b <string_length> # 测试第一个字符串
  401347:	41 89 c4             	mov    %eax,%r12d # 保存第一个字符串的长度到r12d
  40134a:	48 89 ef             	mov    %rbp,%rdi 
  40134d:	e8 c9 ff ff ff       	callq  40131b <string_length> # 测试第二个字符串
  401352:	ba 01 00 00 00       	mov    $0x1,%edx
  401357:	41 39 c4             	cmp    %eax,%r12d # 比较两个字符串的长度
  40135a:	75 3f                	jne    40139b <strings_not_equal+0x63> # 如果不同 返回1
  40135c:	0f b6 03             	movzbl (%rbx),%eax
  40135f:	84 c0                	test   %al,%al
  401361:	74 25                	je     401388 <strings_not_equal+0x50> # 如果al等于\0，返回0
  401363:	3a 45 00             	cmp    0x0(%rbp),%al # 对比两个字符串的第一个字符
  401366:	74 0a                	je     401372 <strings_not_equal+0x3a> # 如果相等，跳转至401372
  401368:	eb 25                	jmp    40138f <strings_not_equal+0x57> # 如果不相等返回1
  40136a:	3a 45 00             	cmp    0x0(%rbp),%al
  40136d:	0f 1f 00             	nopl   (%rax)
  401370:	75 24                	jne    401396 <strings_not_equal+0x5e>
  401372:	48 83 c3 01          	add    $0x1,%rbx # 跳转到下一个字符，继续测试
